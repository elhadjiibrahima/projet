...
function presenter_vue_l_joueurs(string $view,string $the_controller):void{
    ...
    if(isset($_GET['page'])){
        ...
        if($page_actuel>$nbrede_page){
            $page_actuel=$nbrede_page;
    ...
    $indicededepart=($page_actuel-1)*nombredejoueur_parpage;
    $indicedefin=$indicededepart+nombredejoueur_parpage-1;
    $t=[];
    ...
    ///////////////////////////////////////////////////
    require_once(PATH_VIEWS.$the_controller.DIRECTORY_SEPARATOR.$view);
    // for($page=1;$page<=$nbrede_page;$page++){
