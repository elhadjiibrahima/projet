...
<section class="content-register">
    ...
    <div class="choose-avatar" id="choose-avatar">
        <figure>
            ...
            <img src="<?=WEB_PUBLIC."img".DIRECTORY_SEPARATOR."avatar".DIRECTORY_SEPARATOR."Mimo.jpg" ?>" id="new-image" alt="" srcset="">
        </figure>
        ...
        <!-- <p class="error-of-upload-file">Aucun photo chargé,voulez-vous celui là par défaut </p> -->
    </div>
</section>
